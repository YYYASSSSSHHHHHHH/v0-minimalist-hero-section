...
const AnimatedHero7 = ({
  heading = "Premium Notion Templates That Convert",
  description = "Beautifully designed, professionally crafted Notion templates to boost your productivity and streamline your workflow. Ready to use, easy to customize.",
  button = {
      ...
      <div className="container text-center">
        ...
        >
          ...
          <div>
            ...
            <p className="text-muted-foreground text-left font-medium">from {reviews.count}+ reviews</p>
          </div>
        </motion.div>
      </div>
    </section>
